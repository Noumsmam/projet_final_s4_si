        ...
        <main class="app-main">
            <div class="page-grid fade-in">
                <section class="hero-panel">
                    ...
                    <h1 class="hero-title">Bonjour, <?= esc($clientRow['nom'] ?? '') ?> !</h1>
                    <p class="hero-subtitle">Retrouvez vos informations principales et l’état de votre compte dans une interface plus claire et plus rapide à lire.</p>
                ...
                <section class="form-panel">
                    <p class="page-kicker">Action rapide</p>
                    ...
                    <form action="/deposer" method="post" class="form-stack">
                        ...
                        <div class="form-group">
                            ...
                            <p class="input-hint">Saisissez un montant positif pour créditer votre compte.</p>
                        </div>
